...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/history/{entity_type}".format(
...
) -> Any | PaginatedResponseHistoryRecordResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | PaginatedResponseHistoryRecordResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | PaginatedResponseHistoryRecordResponse
    """
