...
from ...models.get_failure_rate_analytics_response_200 import (
...
) -> GetFailureRateAnalyticsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetFailureRateAnalyticsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetFailureRateAnalyticsResponse200]:
    return Response(
