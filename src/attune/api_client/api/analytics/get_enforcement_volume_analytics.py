...
from ...models.get_enforcement_volume_analytics_response_200 import (
...
) -> GetEnforcementVolumeAnalyticsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetEnforcementVolumeAnalyticsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetEnforcementVolumeAnalyticsResponse200]:
    return Response(
