...
from ...models.get_execution_throughput_analytics_response_200 import (
...
) -> GetExecutionThroughputAnalyticsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetExecutionThroughputAnalyticsResponse200.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetExecutionThroughputAnalyticsResponse200]:
    return Response(
