...
from ...models.get_worker_status_analytics_response_200 import (
...
) -> GetWorkerStatusAnalyticsResponse200 | None:
    if response.status_code == 200:
        response_200 = GetWorkerStatusAnalyticsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetWorkerStatusAnalyticsResponse200]:
    return Response(
