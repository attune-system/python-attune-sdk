...
T = TypeVar("T", bound="ListArtifactsByExecutionResponse200DataItem")


@_attrs_define
class ListArtifactsByExecutionResponse200DataItem:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        list_artifacts_by_execution_response_200_data_item = cls(
            classification=classification,
            created=created,
            id=id,
            owner=owner,
        ...
        list_artifacts_by_execution_response_200_data_item.additional_properties = d
        return list_artifacts_by_execution_response_200_data_item
