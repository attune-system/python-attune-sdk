...
T = TypeVar("T", bound="GetWorkerStatusAnalyticsResponse200Data")


@_attrs_define
class GetWorkerStatusAnalyticsResponse200Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_worker_status_analytics_response_200_data = cls(
            data=data,
            since=since,
            until=until,
        )

        get_worker_status_analytics_response_200_data.additional_properties = d
        return get_worker_status_analytics_response_200_data
