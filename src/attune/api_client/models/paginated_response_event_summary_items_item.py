...
if TYPE_CHECKING:
    from ..models.paginated_response_event_summary_items_item_payload_type_0 import (
...
class PaginatedResponseEventSummaryItemsItem:
    ...
    Attributes:
        ...
        id (int):
        payload (None | PaginatedResponseEventSummaryItemsItemPayloadType0): Event payload data, when present
    ...
    has_payload: bool
    id: int
    payload: None | PaginatedResponseEventSummaryItemsItemPayloadType0
    trigger_ref: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.payload, PaginatedResponseEventSummaryItemsItemPayloadType0):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        def _parse_payload(
            data: object,
        ) -> None | PaginatedResponseEventSummaryItemsItemPayloadType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                payload_type_0 = (
                    PaginatedResponseEventSummaryItemsItemPayloadType0.from_dict(data)
                )

                return payload_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | PaginatedResponseEventSummaryItemsItemPayloadType0, data)
