...
if TYPE_CHECKING:
    from ..models.paginated_response_event_summary_items_item import (
        PaginatedResponseEventSummaryItemsItem,
    )
    from ..models.pagination_meta import PaginationMeta


T = TypeVar("T", bound="PaginatedResponseEventSummary")


@_attrs_define
class PaginatedResponseEventSummary:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = PaginatedResponseEventSummaryItemsItem.from_dict(
                items_item_data
            )
        ...
        paginated_response_event_summary.additional_properties = d
        return paginated_response_event_summary
