...
T = TypeVar("T", bound="CreateVersionJsonResponse201Data")


@_attrs_define
class CreateVersionJsonResponse201Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        create_version_json_response_201_data = cls(
            artifact=artifact,
            created=created,
            id=id,
            version=version,
        ...
        create_version_json_response_201_data.additional_properties = d
        return create_version_json_response_201_data
