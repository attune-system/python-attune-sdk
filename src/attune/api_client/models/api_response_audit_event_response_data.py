...
if TYPE_CHECKING:
    from ..models.api_response_audit_event_response_data_correlation_chain_type_0 import (
        ApiResponseAuditEventResponseDataCorrelationChainType0,
    )
    from ..models.api_response_audit_event_response_data_details_type_0 import (
...
class ApiResponseAuditEventResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_correlation_chain(
            data: object,
        ) -> ApiResponseAuditEventResponseDataCorrelationChainType0 | None:
            if data is None:
                return data
            try:
                ...
                correlation_chain_type_0 = (
                    ApiResponseAuditEventResponseDataCorrelationChainType0.from_dict(
                        data
                    )
                )
                ...
                pass
            return cast(
                ApiResponseAuditEventResponseDataCorrelationChainType0 | None, data
            )
        ...
        def _parse_details(
            data: object,
        ) -> ApiResponseAuditEventResponseDataDetailsType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                details_type_0 = (
                    ApiResponseAuditEventResponseDataDetailsType0.from_dict(data)
                )
