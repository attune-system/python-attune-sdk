...
T = TypeVar("T", bound="RefreshTokenResponse200Data")


@_attrs_define
class RefreshTokenResponse200Data:
    """Token response
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        refresh_token_response_200_data = cls(
            access_token=access_token,
            expires_in=expires_in,
            refresh_token=refresh_token,
            token_type=token_type,
        ...
        refresh_token_response_200_data.additional_properties = d
        return refresh_token_response_200_data
