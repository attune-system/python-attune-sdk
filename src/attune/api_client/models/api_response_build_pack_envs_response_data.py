...
T = TypeVar("T", bound="ApiResponseBuildPackEnvsResponseData")


@_attrs_define
class ApiResponseBuildPackEnvsResponseData:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        api_response_build_pack_envs_response_data = cls(
            built_environments=built_environments,
            failed_environments=failed_environments,
            summary=summary,
        )

        api_response_build_pack_envs_response_data.additional_properties = d
        return api_response_build_pack_envs_response_data
