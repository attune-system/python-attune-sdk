...
T = TypeVar("T", bound="AppendProgressResponse200Data")


@_attrs_define
class AppendProgressResponse200Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        append_progress_response_200_data = cls(
            classification=classification,
            created=created,
            id=id,
            owner=owner,
        ...
        append_progress_response_200_data.additional_properties = d
        return append_progress_response_200_data
