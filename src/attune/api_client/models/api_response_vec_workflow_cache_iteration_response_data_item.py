...
T = TypeVar("T", bound="ApiResponseVecWorkflowCacheIterationResponseDataItem")


@_attrs_define
class ApiResponseVecWorkflowCacheIterationResponseDataItem:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        api_response_vec_workflow_cache_iteration_response_data_item = cls(
            batch_size=batch_size,
            concurrency=concurrency,
            created=created,
            dispatched_count=dispatched_count,
        ...
        api_response_vec_workflow_cache_iteration_response_data_item.additional_properties = d
        return api_response_vec_workflow_cache_iteration_response_data_item
