...
if TYPE_CHECKING:
    from ..models.event_summary_payload_type_0 import EventSummaryPayloadType0
...
class EventSummary:
    ...
    Attributes:
        ...
        id (int):
        payload (EventSummaryPayloadType0 | None): Event payload data, when present
    ...
    has_payload: bool
    id: int
    payload: EventSummaryPayloadType0 | None
    trigger_ref: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.payload, EventSummaryPayloadType0):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        def _parse_payload(data: object) -> EventSummaryPayloadType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                payload_type_0 = EventSummaryPayloadType0.from_dict(data)

                return payload_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EventSummaryPayloadType0 | None, data)
