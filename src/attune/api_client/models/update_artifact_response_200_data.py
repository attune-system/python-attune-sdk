...
T = TypeVar("T", bound="UpdateArtifactResponse200Data")


@_attrs_define
class UpdateArtifactResponse200Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        update_artifact_response_200_data = cls(
            classification=classification,
            created=created,
            id=id,
            owner=owner,
        ...
        update_artifact_response_200_data.additional_properties = d
        return update_artifact_response_200_data
