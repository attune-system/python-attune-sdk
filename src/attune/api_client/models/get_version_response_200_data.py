...
T = TypeVar("T", bound="GetVersionResponse200Data")


@_attrs_define
class GetVersionResponse200Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_version_response_200_data = cls(
            artifact=artifact,
            created=created,
            id=id,
            version=version,
        ...
        get_version_response_200_data.additional_properties = d
        return get_version_response_200_data
