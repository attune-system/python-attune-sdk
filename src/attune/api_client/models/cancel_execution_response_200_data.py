...
if TYPE_CHECKING:
    from ..models.cancel_execution_response_200_data_config import (
        CancelExecutionResponse200DataConfig,
    )
    from ..models.cancel_execution_response_200_data_result import (
        CancelExecutionResponse200DataResult,
    )
    from ..models.cancel_execution_response_200_data_worker_affinity_type_0 import (
        CancelExecutionResponse200DataWorkerAffinityType0,
    )
    from ..models.cancel_execution_response_200_data_worker_selector_type_0 import (
        CancelExecutionResponse200DataWorkerSelectorType0,
    )
    from ..models.cancel_execution_response_200_data_worker_tolerations_type_0_item import (
        CancelExecutionResponse200DataWorkerTolerationsType0Item,
    )
    from ..models.cancel_execution_response_200_data_workflow_task_type_0 import (
...
class CancelExecutionResponse200Data:
    ...
    worker_selector: (
        CancelExecutionResponse200DataWorkerSelectorType0 | None | Unset
    ) = UNSET
    worker_tolerations: (
        list[CancelExecutionResponse200DataWorkerTolerationsType0Item] | None | Unset
    ) = UNSET
    workflow_task: CancelExecutionResponse200DataWorkflowTaskType0 | None | Unset = (
        UNSET
    )
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.worker_affinity, Unset):
            ...
            self.worker_affinity, CancelExecutionResponse200DataWorkerAffinityType0
        ):
        ...
        if isinstance(self.worker_selector, Unset):
            ...
            self.worker_selector, CancelExecutionResponse200DataWorkerSelectorType0
        ):
        ...
        if isinstance(self.workflow_task, Unset):
            ...
            self.workflow_task, CancelExecutionResponse200DataWorkflowTaskType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_worker_affinity(
            ...
            try:
                ...
                worker_affinity_type_0 = (
                    CancelExecutionResponse200DataWorkerAffinityType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CancelExecutionResponse200DataWorkerAffinityType0 | None | Unset, data
            )
        ...
        def _parse_worker_selector(
            ...
            try:
                ...
                worker_selector_type_0 = (
                    CancelExecutionResponse200DataWorkerSelectorType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CancelExecutionResponse200DataWorkerSelectorType0 | None | Unset, data
            )
        ...
        def _parse_worker_tolerations(
            ...
            list[CancelExecutionResponse200DataWorkerTolerationsType0Item]
            | None
            | Unset
        ):
            if data is None:
            ...
            try:
                ...
                for worker_tolerations_type_0_item_data in _worker_tolerations_type_0:
                    worker_tolerations_type_0_item = CancelExecutionResponse200DataWorkerTolerationsType0Item.from_dict(
        ...
        def _parse_workflow_task(
            data: object,
        ) -> CancelExecutionResponse200DataWorkflowTaskType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                workflow_task_type_0 = (
                    CancelExecutionResponse200DataWorkflowTaskType0.from_dict(data)
                )
                ...
                pass
            return cast(
                CancelExecutionResponse200DataWorkflowTaskType0 | None | Unset, data
            )
