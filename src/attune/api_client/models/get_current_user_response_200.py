...
if TYPE_CHECKING:
    from ..models.get_current_user_response_200_data import (
...
class GetCurrentUserResponse200:
    ...
    Attributes:
        data (GetCurrentUserResponse200Data): Current user response
        message (None | str | Unset): Optional message
    """

    data: GetCurrentUserResponse200Data
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = GetCurrentUserResponse200Data.from_dict(d.pop("data"))
