...
T = TypeVar("T", bound="PackWorkflowSyncResponse")


@_attrs_define
class PackWorkflowSyncResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pack_workflow_sync_response = cls(
            errors=errors,
            loaded_count=loaded_count,
            pack_ref=pack_ref,
            registered_count=registered_count,
        ...
        pack_workflow_sync_response.additional_properties = d
        return pack_workflow_sync_response
