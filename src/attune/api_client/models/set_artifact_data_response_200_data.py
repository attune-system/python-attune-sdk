...
T = TypeVar("T", bound="SetArtifactDataResponse200Data")


@_attrs_define
class SetArtifactDataResponse200Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        set_artifact_data_response_200_data = cls(
            classification=classification,
            created=created,
            id=id,
            owner=owner,
        ...
        set_artifact_data_response_200_data.additional_properties = d
        return set_artifact_data_response_200_data
