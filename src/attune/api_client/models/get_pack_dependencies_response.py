...
if TYPE_CHECKING:
    ...
    from ..models.get_pack_dependencies_response_runtime_requirements import (
        GetPackDependenciesResponseRuntimeRequirements,
    )
    from ..models.pack_dependency import PackDependency


T = TypeVar("T", bound="GetPackDependenciesResponse")


@_attrs_define
class GetPackDependenciesResponse:
    ...
    Attributes:
        ...
        runtime_requirements (GetPackDependenciesResponseRuntimeRequirements): Runtime requirements by pack
    """
    ...
    runtime_requirements: GetPackDependenciesResponseRuntimeRequirements
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        runtime_requirements = GetPackDependenciesResponseRuntimeRequirements.from_dict(
            d.pop("runtime_requirements")
        )

        get_pack_dependencies_response = cls(
            analyzed_packs=analyzed_packs,
            dependencies=dependencies,
            errors=errors,
            missing_dependencies=missing_dependencies,
        ...
        get_pack_dependencies_response.additional_properties = d
        return get_pack_dependencies_response
