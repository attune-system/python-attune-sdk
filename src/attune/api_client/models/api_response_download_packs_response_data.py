...
T = TypeVar("T", bound="ApiResponseDownloadPacksResponseData")


@_attrs_define
class ApiResponseDownloadPacksResponseData:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        api_response_download_packs_response_data = cls(
            downloaded_packs=downloaded_packs,
            failed_packs=failed_packs,
            failure_count=failure_count,
            success_count=success_count,
        ...
        api_response_download_packs_response_data.additional_properties = d
        return api_response_download_packs_response_data
