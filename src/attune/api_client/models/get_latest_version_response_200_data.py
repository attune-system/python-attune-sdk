...
T = TypeVar("T", bound="GetLatestVersionResponse200Data")


@_attrs_define
class GetLatestVersionResponse200Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_latest_version_response_200_data = cls(
            artifact=artifact,
            created=created,
            id=id,
            version=version,
        ...
        get_latest_version_response_200_data.additional_properties = d
        return get_latest_version_response_200_data
