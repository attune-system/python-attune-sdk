...
if TYPE_CHECKING:
    ...
    from ..models.event_response_payload_type_0 import EventResponsePayloadType0
...
class EventResponse:
    ...
    Attributes:
        ...
        id (int):
        payload (EventResponsePayloadType0 | None): Event payload data
    ...
    id: int
    payload: EventResponsePayloadType0 | None
    trigger_ref: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.payload, EventResponsePayloadType0):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        def _parse_payload(data: object) -> EventResponsePayloadType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                payload_type_0 = EventResponsePayloadType0.from_dict(data)

                return payload_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(EventResponsePayloadType0 | None, data)
