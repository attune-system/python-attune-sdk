...
T = TypeVar("T", bound="AllocateFileVersionByRefResponse201Data")


@_attrs_define
class AllocateFileVersionByRefResponse201Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        allocate_file_version_by_ref_response_201_data = cls(
            artifact=artifact,
            created=created,
            id=id,
            version=version,
        ...
        allocate_file_version_by_ref_response_201_data.additional_properties = d
        return allocate_file_version_by_ref_response_201_data
