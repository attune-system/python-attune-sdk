...
T = TypeVar("T", bound="FailureRateResponse")


@_attrs_define
class FailureRateResponse:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        failure_rate_response.additional_properties = d
        return failure_rate_response
