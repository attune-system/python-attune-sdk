...
T = TypeVar("T", bound="PaginatedResponseArtifactSummaryItemsItem")


@_attrs_define
class PaginatedResponseArtifactSummaryItemsItem:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        paginated_response_artifact_summary_items_item = cls(
            classification=classification,
            created=created,
            id=id,
            owner=owner,
        ...
        paginated_response_artifact_summary_items_item.additional_properties = d
        return paginated_response_artifact_summary_items_item
