...
T = TypeVar("T", bound="GetArtifactResponse200Data")


@_attrs_define
class GetArtifactResponse200Data:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        get_artifact_response_200_data = cls(
            classification=classification,
            created=created,
            id=id,
            owner=owner,
        ...
        get_artifact_response_200_data.additional_properties = d
        return get_artifact_response_200_data
